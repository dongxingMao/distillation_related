...
class DiffKD(Distiller):
    ...
    def forward_train(self, image, target, **kwargs):
        ...
        with torch.no_grad():
            ...
            label_t_o = self.diffusion_model.reverse_ddim(feats_student["pooled_feat"], stochastic=False, fq_x=None)
        
        tem_student_logits = self.student.fc(label_t_o)
        logits_student = tem_student_logits
        # losses
